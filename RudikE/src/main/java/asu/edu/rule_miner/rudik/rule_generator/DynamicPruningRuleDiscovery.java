...
public class DynamicPruningRuleDiscovery extends HornRuleDiscovery{
  ...
  private Map<HornRule,Double> discoverHornRules(final Set<Pair<String,String>> negativeExamples, final Set<Pair<String,String>> positiveExamples,
    ...
    final int negativeCoverageThreshold = (negativeExamples.size() < 1000) ? (negativeExamples.size() / 100 + 1) : (negativeExamples.size() / 50 + 1);
    final int positiveCoverageThreshold = (positiveExamples.size() < 1000) ? (positiveExamples.size() / 100 + 1) : (positiveExamples.size() / 50 + 1);
